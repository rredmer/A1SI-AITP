"""
Indicator service — wraps common.indicators.technical and common.data_pipeline
for the web app. Computes indicators on Parquet data.
"""
...
class IndicatorService:
    ...
    def compute(
        ...
        """Load Parquet data, compute indicators, return as JSON-serializable dict."""
        import numpy as np
        ...
        # Select only requested columns (or all indicator columns)
